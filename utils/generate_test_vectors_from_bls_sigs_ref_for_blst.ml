...
let sig_files (type a)
    ...
    filenames (sign_fn : Bls12_381_signature.sk -> Bytes.t -> a) =
...
let () =
  ...
  | "minPk" -> exec (module Bls12_381_signature.MinPk) filetype filenames
  | "minSig" -> exec (module Bls12_381_signature.MinSig) filetype filenames
